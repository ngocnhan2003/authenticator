...
function updateCode() {
// console.log(getCode(_secret[0].secret));
//chrome.storage.sync.set({'secrect_2fa': getCode(_secret[0].secret)});
//chrome.cookies.set({ "name": 'secrect_2fa', "url": "http://exacoin.co/dashboard/ico", "value": getCode(_secret[0].secret)+'' });
//$('[class="crd-value"]').innerText = getCode(_secret[0].secret);
...
// var popupWindow = window.open(chrome.extension.getURL("popup.html"), "2FA", "width=400,height=400");
//window.close();
